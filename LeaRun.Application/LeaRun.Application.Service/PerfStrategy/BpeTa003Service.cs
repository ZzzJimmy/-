    ...
    public class BpeTa003Service : RepositoryFactory<BpeTa003Entity>, IBpeTa003Service
    {
        ...
        IEnumerable<BpeTa002Model> IBpeTa003Service.GetQuantifyPageList(Pagination pagination, string queryJson)
        {
            ...
            sbSql.Append(@" SELECT * FROM( SELECT 
                            ...
                            INNER JOIN [BPMS].[BPE_TA001] TA001 ON TA001.JXBM=TA002.JXBM AND TA001.ZBBH=TA002.ZBBH
                        union 
                            SELECT 
	                             TB001.ZBMC,
	                             TB001.ZBBH,
                                 ...
                                 TA002.[KPIBH],TA002.[JXBM]
                            FROM [HQPAS].[BPMS].[BPE_TA002] TA002
                            INNER JOIN [BPMS].[BPE_TB001] TB001 ON TB001.JXBM=TA002.JXBM AND TB001.ZBBH=TA002.ZBBH
                            )T
                            WHERE 1=1");
